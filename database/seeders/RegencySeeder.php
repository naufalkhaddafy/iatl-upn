...
class RegencySeeder extends Seeder
{
    ...
    public function run(): void
    {
        $data = [
            ...
            [9271, "KOTA SORONG",  92],
            [9301, "KABUPATEN MERAUKE",  93],
            [9302, "KABUPATEN BOVEN DIGOEL",  93],
            [9303, "KABUPATEN MAPPI",  93],
            [9304, "KABUPATEN ASMAT",  93],
            [9401, "KABUPATEN NABIRE",  94],
            [9402, "KABUPATEN PUNCAK JAYA",  94],
            [9403, "KABUPATEN PANIAI",  94],
            [9404, "KABUPATEN MIMIKA",  94],
            [9405, "KABUPATEN PUNCAK",  94],
            [9406, "KABUPATEN DOGIYAI",  94],
            [9407, "KABUPATEN INTAN JAYA",  94],
            [9408, "KABUPATEN DEIYAI",  94],
            [9501, "KABUPATEN JAYAWIJAYA",  95],
            [9502, "KABUPATEN PEGUNUNGAN BINTANG",  95],
            [9503, "KABUPATEN YAHUKIMO",  95],
            [9504, "KABUPATEN TOLIKARA",  95],
            [9505, "KABUPATEN MAMBERAMO TENGAH",  95],
            [9506, "KABUPATEN YALIMO",  95],
            [9507, "KABUPATEN LANNY JAYA",  95],
            [9508, "KABUPATEN NDUGA",  95],
        ];
